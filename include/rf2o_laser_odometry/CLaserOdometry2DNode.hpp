...
public:
  ...
  rclcpp::Subscription<mocap4r2_msgs::msg::RigidBodies>::SharedPtr      initPose_sub;
  ...
  void initPoseCallBack(const mocap4r2_msgs::msg::RigidBodies::SharedPtr  new_initPose);
};
